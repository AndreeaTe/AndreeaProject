            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li><a class="nav-link" href="{{ route('login') }}">{{ __('Logare') }}</a></li>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <form id="edit-form" action="{{ route('editProfile',  Auth::user()->id) }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
