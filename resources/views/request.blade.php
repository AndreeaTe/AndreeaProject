    ...
    <form  method="post" action="{{route('request')}}" enctype="multipart/form-data">
        ...
        <div class="checkboxType">
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="customRadioInline1" name="type" class="custom-control-input" value="1" {{old('type') == 1 ? 'checked': '' }}>
                <label class="custom-control-label" for="customRadioInline1">Angajare</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="customRadioInline2" name="type" class="custom-control-input" value="2" {{old('type') == 2 ? "checked": '' }}>
                <label class="custom-control-label" for="customRadioInline2">Control medical periodic</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="customRadioInline3" name="type" class="custom-control-input" value="3" {{old('type') == 3 ? "checked": '' }}>
                <label class="custom-control-label" for="customRadioInline3">Adaptare</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="customRadioInline4" name="type" class="custom-control-input" value="4" {{old('type') == 4 ? "checked": '' }} >
                <label class="custom-control-label" for="customRadioInline4">Reluarea muncii</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="customRadioInline5" name="type" class="custom-control-input" value="5" {{old('type') == 5 ? "checked": '' }} >
                <label class="custom-control-label" for="customRadioInline5">Supraveghere specială</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="customRadioInline6" name="type" class="custom-control-input" value="6" {{old('type') == 6 ? "checked": '' }} >
        ...
        <div class="form-group form-inline fisa_nr">
            ...
            <input type="text" name="file" class="form-control mx-sm-3">
        </div>
        <div class="form-row">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="nameCompany" name="nameCompany" autocomplete="on">
            ...
            <div class="col-md-6" style="margin-top: 20px; ">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" id="customRadio1" name="medicalOpinion" value="1" {{old('type') == 1 ? 'checked': '' }} class="custom-control-input" >
                    <label class="custom-control-label" for="customRadio1">APT</label>
                </div>
                <div class="custom-control custom-radio">
                    <input type="radio" id="customRadio2" name="medicalOpinion" value="2" {{old('type') == 2 ? 'checked': '' }} CONDITIONAT" class="custom-control-input">
                    <label class="custom-control-label" for="customRadio2">APT CONDITIONAT</label>
                </div>
                 <div class="custom-control custom-radio">
                    <input type="radio" id="customRadio3" name="medicalOpinion"  value="3" {{old('type') == 3 ? 'checked': '' }} class="custom-control-input" >
                    <label class="custom-control-label" for="customRadio3">INAPT TEMPORAR</label>
                </div>
                <div class="custom-control custom-radio">
                    <input type="radio" id="customRadio4" name="medicalOpinion" value="4" {{old('type') == 4 ? 'checked': '' }} class="custom-control-input">
        ...
        <div class="row">
            <div class="col-md-6">
               <div class="form-row ">
                ...
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="CNP" name="CNP" value="{{ old('CNP') }}">
                </div>
                <div class="form-row ">
                    <div class="form-group col-md-6">
            ...
            <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <textarea class="form-control" name="recommendations" rows="9" cols="50">{{ old('recommendations') }}</textarea>
